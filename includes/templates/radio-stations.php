...
//echo '<p><strong>' . get_post_meta( $post->ID, 'fccpod_stations_tagline', true ) . '</strong></p>';
//echo '<p>' . get_post_meta( $post->ID, 'fccpod_stations_announcements', true ) . '</p>';
...
<h6><?php echo get_post_meta( $post->ID, 'fccpod_stations_footnote', true ); ?></h6>
