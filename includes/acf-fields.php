...
acf_add_local_field_group(array (
	...
	'fields' => array (
		...
		array (
			...
			'default_value' => 'outdoors,hunting,fishing,destinations,recreation',
...
acf_add_local_field_group(array (
	...
	'fields' => array (
		array (
			'key' => 'field_56ba518640247',
			'label' => 'Radio Page',
			'name' => 'radio_page_toggle',
			'type' => 'true_false',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
			...
			'message' => 'Disable dynamic \'Radio\' page template',
			'default_value' => 0,
		),
		array (
			'key' => 'field_56b24ab5df4c1',
			'label' => '"Stations" Layout Format',
...
acf_add_local_field_group(array (
	...
	'fields' => array (
		array (
			...
			'name' => 'fccpod_header_description',
			'type' => 'textarea',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array (
			...
			'name' => 'fccpod_upcoming_shows_header',
			'type' => 'text',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array (
			...
			'name' => 'fccpod_upcoming_shows_footnote',
			'type' => 'text',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array (
				'width' => '',
				'class' => '',
				'id' => 'fccpod_upcoming_shows_footer',
			),
		...
		array (
			...
			'name' => 'fccpod_stations_announcements',
			'type' => 'textarea',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array (
			...
			'name' => 'fccpod_radio_page_footnote',
			'type' => 'text',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array (
			'key' => 'field_56bd222002be5',
			'label' => 'Contact Form Page',
			'name' => 'fccpod_radio_contact_form_page',
			'type' => 'post_object',
			'instructions' => 'Place the Contact Form shortcode in page, then choose the corresponding page containing the contact form here. ',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array (
				'width' => '',
