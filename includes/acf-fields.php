...
if( function_exists('acf_add_local_field_group') ) {
	...
	$message = '<a href="'.$feed_url.'" target="_blank">'.$feed_url.'</a>';

	acf_add_local_field_group(array (
		'key' => 'group_57f5601276359',
		'title' => 'Feed Info',
		'fields' => array (
			array (
				'key' => 'field_57f560aea05b9',
				'label' => 'Feed URL',
				'name' => '',
				'type' => 'message',
				'instructions' => '',
			...
			array (
				'key' => 'field_57f563f0f37e6',
				'label' => 'iTunes Store URL',
				'name' => 'itunes_store_url',
				'type' => 'url',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
